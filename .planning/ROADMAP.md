...
**Research status:** all 7 deep-research streams are complete. Reports in `.planning/research/`: `v0.4-mc-llm-planning.md`, `v0.4-mc-mineflayer-skills.md`, `v0.4-mc-rl-hybrid.md` (Phase 17); `v0.4-companion-personality-memory.md`, `v0.4-persona-prompting-and-steering.md`, `v0.4-memory-and-relationship.md` (Phase 16, plus deferred tone); `v0.4-varied-behavior-and-minigames.md` (Phase 21).
