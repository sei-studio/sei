...
export const ZH_MISC: Record<string, string> = {
  ...
  "This world's Minecraft version is not supported yet. Sei works with Minecraft Java {oldest} to {newest}. In the Minecraft Launcher, go to Installations, click New installation, pick {newest} as the version, then open your world from it and press Launch again.":
    '暂不支持这个世界的 Minecraft 版本。Sei 支持 Minecraft Java 版 {oldest} 至 {newest}。在 Minecraft 启动器中进入「安装」，点击「新建安装」，将版本选为 {newest}，然后用它打开你的世界，再次点击启动。',
