...
export const ZH_SCREENS_B: Record<string, string> = {
  ...
  'How old should your companions feel?': '你希望你的伙伴给人感觉多大年纪？',
  'This shapes how the companions Sei casts for you come across. You can update this any time from Settings.':
    '这会影响 Sei 为你召唤的伙伴给人的感觉。你可以随时在设置中更新。',
  'What are you looking for?': '你在寻找什么样的伙伴？',
  "Rank what you're hoping to meet. Your first companion matches your first pick, the next one your second, and so on. You don't have to rank them all.":
    '给你希望遇到的类型排序。你的第一个伙伴对应你的第一选择，下一个对应第二选择，以此类推。不必全部排完。',
  'Pick an art style': '选择一种画风',
  'How your companions look when Sei gives them a face.': '当 Sei 给伙伴一张脸时，他们的样子。',
  'Companion age range': '伙伴年龄范围',
  'Companion dynamics ranking': '伙伴关系排序',
  'Art style': '画风',
  'Surprise me': '给我惊喜',
  'Let the cast decide who you meet.': '让召唤决定你会遇见谁。',
  'Later': '以后再说',
  'Saving…': '保存中…',
  '1st': '第1',
  '2nd': '第2',
  ...
  '5th': '第5',
  'Young adult': '青年',
  'Fresh, spirited, early twenties energy.': '朝气蓬勃，二十岁出头的活力。',
  'Adult': '成年',
  'Grounded and self-assured.': '沉稳踏实，从容自信。',
  'Mature': '成熟',
  'Seasoned, with lived-in wisdom.': '阅历丰富，带着岁月沉淀的智慧。',
  'Elder': '年长',
  'Old souls who have seen it all.': '看尽世事的老灵魂。',
  'Timeless': '无龄',
  'Ageless, beyond years entirely.': '不受年龄限制，完全超越岁月。',
  'A partner in crime': '一起闯祸的搭档',
  'Always game for the questionable idea.': '再离谱的主意也随时奉陪。',
  'Someone to look after you': '照顾你的人',
  'Warm, steady, keeps an eye on you.': '温暖可靠，时刻惦记着你。',
  'Someone to look after': '需要你照顾的人',
  'A little green. They grow at your side.': '还有些青涩，在你身边慢慢成长。',
  'A chill friend': '一个随性的朋友',
  'Easy company, no drama.': '相处轻松，没有波澜。',
  'Someone who pushes you': '督促你的人',
  'Keeps you sharp, keeps you honest.': '让你保持敏锐，也让你保持诚实。',
  'Round chibi': '圆润 Q 版',
  'Soft, cute, big-headed charm.': '柔软可爱的大头萌感。',
  'Anime': '动漫',
  'Classic Japanese animation look.': '经典日式动画风格。',
  'Cel-shaded': '赛璐璐',
  'Bold lines, flat painterly shading.': '线条鲜明，平涂式的绘画质感。',
  'Cartoon': '卡通',
  'Western animated styling.': '欧美动画风格。',
  '3D': '3D',
  'Rendered, dimensional, modern.': '渲染立体，现代感十足。',
