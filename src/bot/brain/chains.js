/**
/**
 * Chain tracker retired in favor of per-Loop iteration_cap
 ...
 *
 * This file is kept as a no-op shim to avoid breaking imports (orchestrator
 * constructs a chain tracker today; full deletion is a follow-up cleanup
 * once no consumers reference `createChainTracker`).
 *
 ...
 *   size()              -> 0
 *
 * The 60s TTL sweep is removed entirely: under Loop ownership a chain is
 * bounded by the Loop's lifetime, which is bounded by iterationCap +
